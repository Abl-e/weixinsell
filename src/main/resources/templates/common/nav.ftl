<nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
    <ul class="nav sidebar-nav">
        ...
        <li>
            <a href="${springMacroRequestContext.contextPath}/seller/order/list"><i class="fa fa-fw fa-list-alt"></i> 订单</a>
        </li>
        ...
        <li>
            <a href="${springMacroRequestContext.contextPath}/seller/logout"><i class="fa fa-fw fa-list-alt"></i> 登出</a>
        </li>
    </ul>
</nav>